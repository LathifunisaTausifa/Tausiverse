...
import Satellite1 from '../../assets/satelite1.jpg'
    ...
    <div className='bg-black text-white pb-12 relative z-50'>
     <div className='container'>
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 items-center'>
            <div>
            <img data-aos='zoom-in' src={Satellite1} alt="Satellite" className='w-full sm:w-[80%] mx-auto object-cover max-h-[350px]'/>
            </div>
            <div className='space-y-3 xl:pr-36 p-4 border-b-2 border-r-2 border-b-sky-900 border-r-sky-900'>
                <p data-aos='fade-up' className='text-sky-800'>Our Mission</p>
                <p data-aos='fade-up' data-aos-delay='300' className=' uppercase text-5xl'>Rapdistat</p>
